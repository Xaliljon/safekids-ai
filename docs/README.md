...
| # | Document | Status |
|---|---|---|
| 00 | [PROJECT_CHARTER](00_PROJECT_CHARTER.md) | Draft |
...
| 14 | [USER_JOURNEY](14_USER_JOURNEY.md) | Draft |
| 15 | 15_USER_STORIES/ | Empty — pending |

## Pending (listed as next steps in 11/12/13)

`16_USE_CASES` · `17_PRODUCT_SCOPE` · `18_MVP` · `20_PRD` ·
`05_SECURITY_THREAT_MODEL` (recommended — trust is the product)

Architecture decisions live in `/adr`; system diagrams in `/architecture`.
